...
zz = 30  # Enter the number of minutes between capturing videos. Recommended minimum of 15 mins.
siteName = 'headswood'  # Enter the name of the site the module is capturing from. Default is 'trial'. DO NOT
# INCLUDE ANY CAPITALS OR SPECIAL CHARACTERS OR IT WILL NOT WORK. keep it lowercase and simple
capture_duration = 60  # How long do you want to capture the videos for? Minimum advised is about 15-20s, default is 30
...
def ipcamera():
    ...
    while True:
        ...
        output = cv2.VideoWriter(tempname, fourcc, fps, (frame_width, frame_height) )


        starttime = time.time()
        print(starttime)
        finishtime = starttime + capture_duration
        print(finishtime)
