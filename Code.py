...
saveDest = 'C:\\Users\\mj304\\Documents\\codetrial\\newCode'  # Where do you want to save the folders and files?
...
siteName = 'trial'  # Enter the name of the site the module is capturing from. Default is 'trial'
...
camAddress = "192.168.1.64:554"  # This default is for my PC. For a pi, set as default "169.254.240.100:554"
...
# Redefine the time to get upto date stamps for each video
        ...
        filename = siteName + time_string2 + '.avi'  # the name of our videos with be the site, the time, and in the
        ...
        out = cv2.VideoWriter(filename, cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), fps, (frame_width, frame_height))
...
def uploadall():  # Upload data to AWS
    ...
    while True:
        ...
        if sizer > 0:
            ...
            sleep(30)  # After a successful sync allow the upload routine to rest for thirty seconds before restarting
